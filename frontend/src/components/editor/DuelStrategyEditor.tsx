...
export interface IStrategyEditorProps {
    ...
    readonly onSubmitAst: (ast: IRoboAst) => void;
...
export class DuelStrategyEditor extends React.PureComponent<IStrategyEditorProps, IState> {
        ...
        >
            <span>
                ...
                <RaisedButton
                    ...
                    primary
                    style={{ margin: 2, minWidth: 50 }}
                    onClick={() => this.props.onSubmitAst(this.state.roboAst)}
                />
                <RaisedButton
                    label={'reset'}
                    secondary
