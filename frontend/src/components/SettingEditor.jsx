...
import SpaceWorldHighlighter from '../core/spaceWorldHighlighter';
...
class SettingEditor extends React.Component {
    componentDidMount() {
        const spaceWorldMode = new SpaceWorldHighlighter();
        this.editor.editor.getSession().setMode(spaceWorldMode);
    }
